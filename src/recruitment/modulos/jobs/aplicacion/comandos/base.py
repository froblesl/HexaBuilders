"""
Base classes for jobs commands.
"""
...
class CommandJobs(Command):
    """Base command for jobs operations."""
    pass


class ComandoHandlerJobs(ABC):
    """Base command handler for jobs operations."""
    ...
    @abstractmethod
    def handle(self, comando: CommandJobs) -> Any:
        """Handle the command."""
        pass
    
    def _log_command_start(self, comando: CommandJobs):
        """Log command execution start."""
        self._logger.info(f"Starting command execution: {comando.__class__.__name__}")
    
    def _log_command_success(self, comando: CommandJobs, result: Any = None):
        """Log successful command execution."""
        self._logger.info(f"Command executed successfully: {comando.__class__.__name__}")
    
    def _log_command_error(self, comando: CommandJobs, error: Exception):
